...
import { ROOT, exists, isMac, isLinux } from "./lib/env.mjs";
import { bold, dim, green, yellow, cyan, ok, warn, bad, rule } from "./lib/ui.mjs";
...
async function writeCrontab(text) {
  const tmp = join(ROOT, ".data", "crontab.tmp");
  await mkdir(join(ROOT, ".data"), { recursive: true });
